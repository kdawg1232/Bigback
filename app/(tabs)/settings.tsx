  ...
  return (
    <SafeAreaView className="flex-1 bg-brutalist-beige" edges={['top']}>
      <ScrollView className="flex-1 p-6" showsVerticalScrollIndicator={false}>
        <Text className="text-4xl md:text-6xl font-black mb-10 border-b-[8px] border-black pb-4 leading-none text-black uppercase" style={{ transform: [{ skewX: '-6deg' }] }}>
          CONFIG
        </Text>
        ...
        <View className="gap-y-8">
          ...
          <View className="bg-white border-[4px] border-black p-4 md:p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden">
            ...
            <View className="flex-row items-center gap-4 md:gap-5 mt-4">
              <View className="bg-brutalist-yellow border-[4px] border-black w-16 h-16 md:w-20 md:h-20 items-center justify-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                <Text className="text-3xl md:text-5xl">👤</Text>
              </View>
              <View className="flex-1">
                <TextInput 
                  ...
                  className="text-xl md:text-2xl font-black text-black w-full border-b-4 border-black/20 p-1 uppercase"
                />
                <Text className="text-[10px] md:text-[12px] font-black text-black mt-2 tracking-widest uppercase">
          ...
          <View className="bg-white border-[4px] border-black p-3 md:p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] flex-row justify-between items-center">
            <View className="flex-row items-center gap-3 md:gap-4 flex-1 mr-2">
              <Text className="text-2xl md:text-4xl">{stats.remindersEnabled ? '🔔' : '🔕'}</Text>
              <View className="flex-1">
                <Text className="font-black text-base md:text-xl uppercase leading-tight text-black" numberOfLines={1} adjustsFontSizeToFit>Sunday Reflection</Text>
            ...
            <TouchableOpacity 
              ...
              className={`w-10 h-10 md:w-14 md:h-14 border-[4px] border-black items-center justify-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none ${stats.remindersEnabled ? 'bg-brutalist-yellow' : 'bg-gray-200'}`}
            >
          ...
          {/* PRIVACY MANIFESTO */}
          <View 
            className="bg-brutalist-red p-4 md:p-6 border-[4px] border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]"
            style={{ transform: [{ rotate: '1deg' }] }}
          >
            <View className="flex-row items-center gap-4 mb-3">
              <Text className="text-2xl md:text-3xl">🛡️</Text>
              <Text className="font-black text-xl md:text-2xl uppercase italic text-white">No Snitching Policy</Text>
            </View>
            <Text className="text-[10px] md:text-xs font-black leading-relaxed opacity-90 uppercase text-white">
          ...
          <View className="flex-row gap-2 w-full">
            <TouchableOpacity 
              onPress={showTerms}
              style={{ flex: 1 }}
              className="bg-white border-[3px] border-black py-3 md:py-4 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none items-center justify-center"
            >
              <Text className="text-[9px] md:text-[10px] font-black uppercase text-black text-center" numberOfLines={1}>Terms</Text>
            </TouchableOpacity>
            <TouchableOpacity 
              onPress={showPrivacy}
              style={{ flex: 1 }}
              className="bg-white border-[3px] border-black py-3 md:py-4 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none items-center justify-center"
            >
              <Text className="text-[9px] md:text-[10px] font-black uppercase text-black text-center" numberOfLines={1}>Privacy</Text>
            </TouchableOpacity>
            <TouchableOpacity 
              onPress={showSupport}
              style={{ flex: 1 }}
              className="bg-white border-[3px] border-black py-3 md:py-4 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none items-center justify-center"
            >
              <Text className="text-[9px] md:text-[10px] font-black uppercase text-black text-center" numberOfLines={1}>Support</Text>
            </TouchableOpacity>
          </View>
          ...
          <View className="pt-8 mt-4 border-t-[4px] border-black border-dashed gap-y-4">
            <TouchableOpacity 
              ...
              className="w-full bg-white border-[4px] border-black p-4 md:p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] flex-row items-center justify-center gap-4 md:gap-5 active:translate-x-[2px] active:translate-y-[2px] active:shadow-none"
            >
              <Text className="text-2xl md:text-3xl">🚪</Text>
              <Text className="text-xl md:text-2xl font-black uppercase tracking-tighter text-black">Log Out</Text>
            </TouchableOpacity>

            <TouchableOpacity 
              onPress={handleClear}
              className="w-full bg-black border-[4px] border-black p-4 md:p-6 shadow-[6px_6px_0px_0px_rgba(226,18,55,1)] flex-row items-center justify-center gap-4 md:gap-5 active:translate-x-[2px] active:translate-y-[2px] active:shadow-none"
            >
              <Text className="text-2xl md:text-3xl">🗑️</Text>
              <Text className="text-xl md:text-2xl font-black uppercase tracking-tighter text-white">Clear My Food</Text>
            </TouchableOpacity>
          </View>
